...
import EV3.ejercicioempresaprogramacion.empresaprogramacion.excepciones.RutaArchivoInvalida;
          ...
          try{
            try{
              if (Boolean.parseBoolean(datos[4])) {
                ...
                System.out.println("No se ha podido leer el campo 'esJunior' del archivo: "+archivoCargar+". Se ha establecido a false.");
                programador = new Programador(datos[0], datos[1], Double.parseDouble(datos[2]), datos[3], false);
              }
            }catch(NumberFormatException e){
              System.out.println("El salario del archivo: "+archivoCargar+" no es válido. Se ha establecido a 0.");
              programador = new Programador(datos[0], datos[1], 0.0, datos[3], Boolean.parseBoolean(datos[4]));
            }
