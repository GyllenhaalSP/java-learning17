...
public class CuentaBancaria {
    ...
    public void retirarDinero(double cantidad) {
        if (!esMultiplo(cantidad)) retiradaOk(cantidad, false);
    ...
    public void numerosRojos() {
        System.out.println("La cuenta " + numeroCuenta + " ha quedado en números rojos.\n");
    }
    ...
    private void deniegaTransaccion(double cantidad, boolean transferenciaORetirada) {
        System.out.println("No se pueden " + (transferenciaORetirada ? "transferir " : "retirar ")
                + normalizadorDecimales(cantidad) + moneda + " de la cuenta " + numeroCuenta
                + ". Saldo insuficiente.\n");
    }
    ...
    private void depositoOk(double cantidad) {
        System.out.println("Se han ingresado " + normalizadorDecimales(cantidad) + moneda
    ...
    private void retiradaOk(double cantidad, boolean estado) {
        if (estado)
            System.out.println("Se han retirado " + normalizadorDecimales(cantidad) + moneda
                    + " de la cuenta " + numeroCuenta + ".\n");
        else
            System.out.println("No se pueden retirar " + normalizadorDecimales(cantidad) + moneda
    ...
    public void transferenciaOK(double cantidad, CuentaBancaria cuentaDestino) {
        System.out.println("Se han transferido " + normalizadorDecimales(cantidad) + moneda
                + " a la cuenta " + cuentaDestino.numeroCuenta + " desde la cuenta " + numeroCuenta + ".\n");
    }
    ...
    public void estadoRecibo(double cantidad, String recibo, boolean estado) {
        if (estado)
            System.out.println("Se ha cobrado el recibo de " + "\"" + recibo + "\"" + " por importe de "
                    + normalizadorDecimales(cantidad) + moneda + " desde la cuenta "
                    + numeroCuenta + (saldo < 0 ? "." : ".\n"));
        else
            System.out.println("Se ha devuelto el recibo " + "\"" + recibo + "\"" + " por importe de "
                    + normalizadorDecimales(cantidad) + moneda + " de la cuenta " + numeroCuenta
